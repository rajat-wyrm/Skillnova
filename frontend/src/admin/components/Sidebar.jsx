...
//  Refactored: adopted improved collapse/tooltip
//  pattern from OLD REPO (PanelLeftClose/Open).
//  Menu items remain configuration-driven.
// ══════════════════════════════════════════════
  ...
  return (
    <div className="relative h-screen flex-shrink-0 overflow-visible">
      ...
      >
        ...
        >
          {isCollapsed ? (
            // Collapsed: gradient "U" button acts as expand trigger
      ...
      {/* Floating tooltip — only while collapsed */}
      {isCollapsed && tooltip && (
        <div
