...
CREATE TABLE "LearningTracker" (
    ...
    CONSTRAINT "LearningTracker_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "LearningTracker_userId_idx" ON "LearningTracker"("userId");

-- CreateIndex
CREATE INDEX "LearningTracker_date_idx" ON "LearningTracker"("date");

-- CreateIndex
CREATE UNIQUE INDEX "LearningTracker_userId_date_key" ON "LearningTracker"("userId", "date");

-- CreateIndex
CREATE UNIQUE INDEX "LearningStreak_internId_key" ON "LearningStreak"("internId");
...
-- AddForeignKey
ALTER TABLE "LearningTracker" ADD CONSTRAINT "LearningTracker_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LearningStreak" ADD CONSTRAINT "LearningStreak_internId_fkey" FOREIGN KEY ("internId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
