...
-- CreateEnum
CREATE TYPE "DiscussionType" AS ENUM ('DISCUSSION', 'QUESTION', 'FEEDBACK', 'SHOWCASE');
...
-- CreateTable
CREATE TABLE "UserCommunityStats" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "UserCommunityStats_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "_CommunityTagToDiscussionPost" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateTable
CREATE TABLE "_CommunityTagToCommunityTopic" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateTable
CREATE TABLE "_CommunityProjectToCommunityTag" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE INDEX "CommunityTopic_name_idx" ON "CommunityTopic"("name");

-- CreateIndex
CREATE INDEX "CommunityTopic_order_idx" ON "CommunityTopic"("order");

-- CreateIndex
CREATE INDEX "DiscussionPost_authorId_idx" ON "DiscussionPost"("authorId");

-- CreateIndex
CREATE INDEX "DiscussionPost_topicId_idx" ON "DiscussionPost"("topicId");

-- CreateIndex
CREATE INDEX "DiscussionPost_isHot_idx" ON "DiscussionPost"("isHot");
...
-- CreateIndex
CREATE INDEX "DiscussionReply_isAnswer_idx" ON "DiscussionReply"("isAnswer");

-- CreateIndex
CREATE INDEX "DiscussionReply_createdAt_idx" ON "DiscussionReply"("createdAt");

-- CreateIndex
CREATE INDEX "DiscussionUpvote_userId_idx" ON "DiscussionUpvote"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "DiscussionUpvote_userId_postId_key" ON "DiscussionUpvote"("userId", "postId");

-- CreateIndex
CREATE UNIQUE INDEX "DiscussionUpvote_userId_replyId_key" ON "DiscussionUpvote"("userId", "replyId");

-- CreateIndex
CREATE INDEX "CommunityProject_authorId_idx" ON "CommunityProject"("authorId");

-- CreateIndex
CREATE INDEX "CommunityProject_createdAt_idx" ON "CommunityProject"("createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "CommunityProjectLike_userId_projectId_key" ON "CommunityProjectLike"("userId", "projectId");

-- CreateIndex
CREATE UNIQUE INDEX "UserMention_userId_replyId_key" ON "UserMention"("userId", "replyId");

-- CreateIndex
CREATE UNIQUE INDEX "CommunityBadge_name_key" ON "CommunityBadge"("name");

-- CreateIndex
CREATE INDEX "CommunityBadge_name_idx" ON "CommunityBadge"("name");
...
-- CreateIndex
CREATE UNIQUE INDEX "UserCommunityStats_userId_key" ON "UserCommunityStats"("userId");

-- CreateIndex
CREATE INDEX "UserCommunityStats_pointsEarned_idx" ON "UserCommunityStats"("pointsEarned");

-- CreateIndex
CREATE INDEX "UserCommunityStats_lastActivityAt_idx" ON "UserCommunityStats"("lastActivityAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "_CommunityTagToDiscussionPost_AB_unique" ON "_CommunityTagToDiscussionPost"("A", "B");

-- CreateIndex
CREATE INDEX "_CommunityTagToDiscussionPost_B_index" ON "_CommunityTagToDiscussionPost"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_CommunityTagToCommunityTopic_AB_unique" ON "_CommunityTagToCommunityTopic"("A", "B");

-- CreateIndex
CREATE INDEX "_CommunityTagToCommunityTopic_B_index" ON "_CommunityTagToCommunityTopic"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_CommunityProjectToCommunityTag_AB_unique" ON "_CommunityProjectToCommunityTag"("A", "B");

-- CreateIndex
CREATE INDEX "_CommunityProjectToCommunityTag_B_index" ON "_CommunityProjectToCommunityTag"("B");
...
-- AddForeignKey
ALTER TABLE "DiscussionPost" ADD CONSTRAINT "DiscussionPost_topicId_fkey" FOREIGN KEY ("topicId") REFERENCES "CommunityTopic"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DiscussionUpvote" ADD CONSTRAINT "DiscussionUpvote_replyId_fkey" FOREIGN KEY ("replyId") REFERENCES "DiscussionReply"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CommunityProject" ADD CONSTRAINT "CommunityProject_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "UserMention" ADD CONSTRAINT "UserMention_replyId_fkey" FOREIGN KEY ("replyId") REFERENCES "DiscussionReply"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserBadge" ADD CONSTRAINT "UserBadge_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserBadge" ADD CONSTRAINT "UserBadge_badgeId_fkey" FOREIGN KEY ("badgeId") REFERENCES "CommunityBadge"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserCommunityStats" ADD CONSTRAINT "UserCommunityStats_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_CommunityTagToDiscussionPost" ADD CONSTRAINT "_CommunityTagToDiscussionPost_A_fkey" FOREIGN KEY ("A") REFERENCES "CommunityTag"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CommunityTagToDiscussionPost" ADD CONSTRAINT "_CommunityTagToDiscussionPost_B_fkey" FOREIGN KEY ("B") REFERENCES "DiscussionPost"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CommunityTagToCommunityTopic" ADD CONSTRAINT "_CommunityTagToCommunityTopic_A_fkey" FOREIGN KEY ("A") REFERENCES "CommunityTag"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CommunityTagToCommunityTopic" ADD CONSTRAINT "_CommunityTagToCommunityTopic_B_fkey" FOREIGN KEY ("B") REFERENCES "CommunityTopic"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CommunityProjectToCommunityTag" ADD CONSTRAINT "_CommunityProjectToCommunityTag_A_fkey" FOREIGN KEY ("A") REFERENCES "CommunityProject"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CommunityProjectToCommunityTag" ADD CONSTRAINT "_CommunityProjectToCommunityTag_B_fkey" FOREIGN KEY ("B") REFERENCES "CommunityTag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
