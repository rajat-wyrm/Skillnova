...
-- CreateEnum
CREATE TYPE "ReportStatus" AS ENUM ('DRAFT', 'SUBMITTED', 'UNDER_REVIEW', 'NEEDS_REVISION', 'APPROVED', 'PENDING', 'REVIEWED', 'REJECTED');

-- CreateEnum
CREATE TYPE "DailyWorkLogStatus" AS ENUM ('OPEN', 'LOCKED', 'REOPENED');
...
CREATE TABLE "DailyWorkLog" (
    ...
    "challenges" TEXT,
    "tomorrowPlan" TEXT,
    "status" "DailyWorkLogStatus" NOT NULL DEFAULT 'OPEN',
    "reopenedById" TEXT,
...
-- CreateIndex
CREATE INDEX "DailyWorkLog_reportId_idx" ON "DailyWorkLog"("reportId");
...
-- CreateIndex
CREATE INDEX "ReportReview_reviewedById_idx" ON "ReportReview"("reviewedById");
...
-- AddForeignKey
ALTER TABLE "DailyWorkLog" ADD CONSTRAINT "DailyWorkLog_reportId_fkey" FOREIGN KEY ("reportId") REFERENCES "Report"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "DailyWorkLog" ADD CONSTRAINT "DailyWorkLog_reopenedById_fkey" FOREIGN KEY ("reopenedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReportReview" ADD CONSTRAINT "ReportReview_reviewedById_fkey" FOREIGN KEY ("reviewedById") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
