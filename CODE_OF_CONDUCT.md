...
This Code of Conduct applies within all project spaces — the repository, the
issue tracker, discussions, pull requests, and any other communication channel
used by the community. It also applies when an individual is officially
representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be
reported to the project team at **rajatkumar7861813@gmail.com**. All
